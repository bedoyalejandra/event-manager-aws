...
DB_USERNAME=${DB_USERNAME:-eventadmin}
...
# PASO 8: Nota sobre RDS
show_progress 8 10 "Base de Datos RDS"

log_info "RDS será desplegado automáticamente por CloudFormation en el stack principal"
log_success "✅ RDS configurado en el master template"

# PASO 9: Desplegando stack principal
show_progress 9 10 "Desplegando Infraestructura Principal"
...
show_progress 10 10 "Verificando el Despliegue"
...
DB_ENDPOINT=$(get_stack_output event-manager DBEndpoint)
...
log_success "🗄️ Database Endpoint: $DB_ENDPOINT"
echo ""

log_info "Listando funciones Lambda creadas..."
aws lambda list-functions \
    --query 'Functions[?contains(FunctionName, `event-manager`)].{Name:FunctionName,Runtime:Runtime}' \
    --output table
